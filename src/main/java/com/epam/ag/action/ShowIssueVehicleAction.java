 ...
 */
public class ShowIssueVehicleAction extends UserAction implements Action {

    private static final Logger log = LoggerFactory.getLogger(ShowIssueVehicleAction.class);
