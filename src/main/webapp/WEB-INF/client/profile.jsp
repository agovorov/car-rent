...
<%--Format dates--%>
<fmt:formatDate var="pass_issue_date" type="date" pattern="dd.MM.yyyy" value="${user.getPassport().getIssueDate() }"/>
<fmt:formatDate var="pass_expire_date" type="date" pattern="dd.MM.yyyy"
                value="${user.getPassport().getExpirationDate()}"/>
...
<c:set var="pass_issue" value="${not empty param.pass_issue ? param.pass_issue : pass_issue_date}"/>
<c:set var="pass_expire" value="${not empty param.pass_expire ? param.pass_expire : pass_expire_date}"/>
...
<a:client_page title="${pageHeader}" breadcrumbItems="${breadcrumbItems}">
    <form method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" disabled name="email" id="email" value="${email}" class="form-control"
        ...
        <div class="form-group">
            ...
            <input type="text" name="pass_series" id="pSeries" maxlength="10" value="${pass_series}"
                   class="form-control"
        ...
        <div class="form-group">
            ...
            <input type="text" name="pass_number" id="pDocNumber" maxlength="30" value="${pass_number}"
                   class="form-control"
        ...
        <div class="form-group">
            ...
            <input type="text" name="pass_issue" id="pDIssue" maxlength="10" value="${pass_issue}"
        ...
        <div class="form-group">
            ...
            <input type="text" name="pass_expire" id="pExpire" maxlength="10" value="${pass_expire}" class="form-control
            date"
